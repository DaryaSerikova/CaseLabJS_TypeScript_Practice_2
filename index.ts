...
type DictionaryStudent = { students: { [id: string]: ( User | Student ) } }
type DictionaryTeacher = { teachers: { [id: string]: User & WithLevel & WithRate } }
type Director = User & DictionaryStudent & DictionaryTeacher;
